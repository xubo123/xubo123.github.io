...
<script type="text/javascript">
	...
	//	}
		if ($('form').form('validate')){
			$.ajax({
				url : '${pageContext.request.contextPath}/mobNewsType/mobNewsTypeAction!saveNewsChannel.action',
				data : $('form').serialize(),
				dataType : 'json',
...
<input id="parent_id" type="hidden" name="channel.channel_pid" value="<%=parent_id %>">
<fieldset>
		<legend>
			栏目信息
		</legend>
		<table class="ta001">
			<tr>
				...
				<td colspan="3">
					<input id="name" name="channel.channel_name" class="easyui-validatebox"
						style="width: 300px;"
	...
	<%-- 		<tr>
			...
			<tr>
				...
				<td colspan="3">
					<select id="type" name="channel.channel_type" onchange="selectType();">
			...
			<tr id="trUrl" style="display:none;">
				...
				<td colspan="3">
					<input id="url" style="width: 700px;" name="channel.channel_url" type="text"   value="">
				</td>
			</tr>
		<!--  	<tr id="trNewsTitle" style="display:none;">
			...
			<tr>
				...
				<td colspan="3">
					<input id="orderNum" name="channel.channel_ordernum" class="easyui-validatebox"
						style="width: 150px;"
