...
<html>
  <head>
	...
	<script type="text/javascript">
		$(function() {
			$.ajax({
				url : '${pageContext.request.contextPath}/page/admin/email/emailAction!sendEmail.action?ids='+${param.ids},
				dataType : 'json',
...
<form method="post" id="addForm">
	<table class="ta001">
		...
		<tr>
			...
			<td colspan="3">
			<input name="emailType1" id="emailType1" type="hidden"></input>
