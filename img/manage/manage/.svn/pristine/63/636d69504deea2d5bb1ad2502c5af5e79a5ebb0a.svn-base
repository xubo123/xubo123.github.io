...
public class XingeApp {
	...
	// 易用的api接口v1.1.4引入
	public static JSONObject pushTokenAndroid(long accessId, String secretKey, String title, List<SingleNewsMessage> content, String token)
	{
	...
	public static JSONObject pushAccountAndroid(long accessId, String secretKey, String title, List<SingleNewsMessage> content, String account)
	{
		Message message = new Message();
		message.setType(Message.TYPE_NOTIFICATION);
		message.setTitle(title);
	...
	public static JSONObject pushAllAndroid(long accessId, String secretKey, String title, List<SingleNewsMessage> content)
	{
		Message message = new Message();
		message.setType(Message.TYPE_NOTIFICATION);
		message.setTitle(title);
	...
	public static JSONObject pushTagAndroid(long accessId, String secretKey, String title, List<SingleNewsMessage> content, String tag)
	{
		Message message = new Message();
		message.setType(Message.TYPE_NOTIFICATION);
		message.setTitle(title);
