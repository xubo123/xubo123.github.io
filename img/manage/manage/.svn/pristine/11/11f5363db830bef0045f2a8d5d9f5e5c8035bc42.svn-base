...
public class Message {
	...
	public Message() {
		this.m_title = "";
		this.m_content = new ArrayList<SingleNewsMessage>();
	...
	public void setContent(List<SingleNewsMessage> content) {
	...
	public String toJson() {
		...
		if (m_type == TYPE_NOTIFICATION) {
			...
			if (m_content != null && m_content.size()!=0) {
				json.put("content", m_content);
			} else {
				json.put("content", event_content);
			}
	...
	public List<PushedEvent> getEvent_content() {
		return event_content;
	}

	public void setEvent_content(List<PushedEvent> event_content) {
		this.event_content = event_content;
	}

	private String m_title;
	private List<SingleNewsMessage> m_content;
	private List<PushedEvent> event_content;
