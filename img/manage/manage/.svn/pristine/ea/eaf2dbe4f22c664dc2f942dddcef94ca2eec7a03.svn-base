	...
	<head>
		...
		function submitForm($dialog, $grid, $pjq) {
			...
			if ($('form').form('validate')) {
				$.ajax({
					url : '${pageContext.request.contextPath}/dept/deptAction!importDepartment.action',
					data : $('form').serialize(),
					dataType : 'json',
			...
			<fieldset>
				...
				<table class="ta001">
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/template/department_template.xls">模板下载</a>
						</td>
					</tr>
					<%--<tr>
						<th>
