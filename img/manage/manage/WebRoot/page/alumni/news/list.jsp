...
$(function(){
	...
	/* 		    {field:'cityName',title:'所属城市',width:80,align:'center'},
			    ...
			    {field:'operator',title:'操作',width:100,
			    		formatter: function(value,row,index){
							var content="";
							<authority:authority authorizationCode="查看校友会新闻" role="${sessionScope.user.role}">
			    			content+='<a href="javascript:void(0)" onclick="viewNews('+row.newsId+')"><img class="iconImg ext-icon-note"/>查看</a>&nbsp;';
			    			</authority:authority>
			    			<authority:authority authorizationCode="编辑校友会新闻" role="${sessionScope.user.role}">
			...
			<tr>
				<td>
					<table>
						<tr>
							<td>
							<authority:authority authorizationCode="新增校友会新闻" role="${sessionScope.user.role}">
								<a href="javascript:void(0);" class="easyui-linkbutton"
							...
							<td>
							<authority:authority authorizationCode="删除校友会新闻" role="${sessionScope.user.role}">
								<a href="javascript:void(0);" class="easyui-linkbutton"
							...
							<td>
							<authority:authority authorizationCode="发送校友会新闻" role="${sessionScope.user.role}">
								<a href="javascript:void(0);" class="easyui-linkbutton"
