                    ...
                    success: function (result) {
                        if (result.id != undefined) {
                            $('form').form('load', {
                                ...
                                'event.department_id': result.department_id,
                            ...
                            if(result.pic != null && result.pic != '') {
                            	$('#eventPic').append('<div style="float:left;width:180px;"><img src="'+result.picUrl+'" width="150px" height="150px"/><div class="bb001" onclick="removeeventPic(this)"></div><input type="hidden" name="event.pic" id="eu" value="'+result.pic+'"/></div>');
