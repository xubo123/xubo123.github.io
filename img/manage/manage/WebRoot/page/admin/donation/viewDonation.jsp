					...
					success : function(result){  
						if (result.donationId != undefined) {
							$('form').form('load', {
								...
								'confirmPeple':result.user!=undefined?result.user.userName:''
							});
							if(result.flag==1&&(result.userId!=''||result.userId!=undefined)){
								$('#flag').prop('value','正式校友')
							}
							if(result.flag==1&&(result.userId==''||result.userId==undefined)){
								$('#flag').prop('value','待核校友')
							}
							if(result.flag==0){
								$('#flag').prop('value','非校友')
							}
			...
			<fieldset>
				...
				<table class="ta001">
					<tr>
						...
						<td>
							<input name="confirmTime" disabled="disabled" type="text"></input>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td colspan="3">
							<input name="confirmPeple" disabled="disabled" type="text"></input>
						</td>
					</tr>
				</table>
			</fieldset>
