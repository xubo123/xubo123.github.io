					...
					.ajax({
						...
						/* 		if (result.channel_pid == 0) {
								...
								if (result.channel_type == 1) {
								    ...
								    $("#trUrl").css("display", result.channel_url);
								  }
							}
						},
						beforeSend : function() {
...
<body>
	<form method="post" id="addNewsForm">
		...
		<fieldset>
			...
			<!-- 	<tr>
					<th>栏目级别</th>
					<td colspan="3"><input id="level" style="width: 150px;"
						type="text" maxlength="30" disabled="disabled"></td>
				</tr> -->
				<tr>
					<th>栏目类型</th>
				...
				<tr id="trUrl">
					...
					<td colspan="3"><input id="url" style="width: 700px;"
						name="channel.channel_url" type="text"></td>
				</tr>
				<!--	
			...
			<tr id="trOrigin" style="display:none;">
		 	...
		 	<tr>
				...
				<tr>
					<th>排序编号</th>
					<td colspan="3"><input id="orderNum" name="channel.channel_ordernum"
						class="easyui-validatebox" style="width: 150px;"
						data-options="required:true,validType:'tel'" maxlength="20"
						value="" />&nbsp;&nbsp;&nbsp;&nbsp;( 数字越小越靠前)
					</td>
				</tr>
