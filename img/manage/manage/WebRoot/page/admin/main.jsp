...
<html>
	...
	<body id="mainLayout" class="easyui-layout" style="overflow-y: hidden" scroll="no">
		<div data-options="region:'north',href:'${pageContext.request.contextPath}/page/admin/north.jsp'"  style="height: 70px; overflow: hidden;background-image: url('images/cctop.jpg');background-repeat: repeat-x;">
		</div>
		<div data-options="region:'south'" style="height: 30px;">
			<div align="center" style="margin-top: 5px;">
				Copyright © 2016 wust.edu.cn All Rights Reserved.
			</div>
		</div>
			...
			<div id="mainTabs">
				<div title="我的主页" data-options="iconCls:'ext-icon-homePage'">
					<iframe src="${pageContext.request.contextPath}/page/admin/welcome.jsp" allowTransparency="true"
						style="border: 0; width: 100%; height: 99%;background-image: url('images/tta1.jpg');background-position: center;background-repeat: no-repeat;" frameBorder="0"></iframe>
				</div>
			</div>
		</div>
